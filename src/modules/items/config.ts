  ...
  filters: [
    {
      ...
      options: [
        ...
        { value: "fermentable", label: "Zkvasitelná přísada" },
...
export const catalogBrowserConfig: DataBrowserConfig = {
  ...
  columns: [
    ...
    { key: "demandedQty", label: "Požadavky", type: "number", sortable: true },
    { key: "availableQty", label: "Disponibilní", type: "number", sortable: true },
    { key: "costPrice", label: "Cena", type: "currency", sortable: true },
    { key: "isActive", label: "Aktivní", type: "boolean" },
  ],
