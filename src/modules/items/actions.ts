...
function mapRow(row: typeof items.$inferSelect): Item {
  return {
    ...
    fermentableType: row.fermentableType ?? null,
    alpha: row.alpha,
    ebc: row.ebc,
    extractPercent: row.extractPercent,
    hopForm: row.hopForm ?? null,
    yeastForm: row.yeastForm ?? null,
  ...
  return withTenant(async (tenantId) => {
    ...
    const rows = await db
      ...
      .values({
        ...
        fermentableType: data.fermentableType,
        alpha: data.alpha,
        ebc: data.ebc,
        extractPercent: data.extractPercent,
        hopForm: data.hopForm,
        yeastForm: data.yeastForm,
  ...
  return withTenant(async (tenantId) => {
    ...
    const rows = await db
      ...
      .values({
        ...
        fermentableType: original.fermentableType,
