...
function mapBatchRow(
  ...
  return {
    ...
    conditioningEquipmentId: row.conditioningEquipmentId ?? null,
    ...
    conditioningDays: row.conditioningDays ?? null,
...
function mapStepRow(row: typeof batchSteps.$inferSelect): BatchStep {
  return {
    ...
    actualDurationMin: row.actualDurationMin ?? null,
    stepSource: row.stepSource ?? null,
    rampTimeMin: row.rampTimeMin ?? null,
    hopAdditions: (row.hopAdditions as BatchStep["hopAdditions"]) ?? null,
