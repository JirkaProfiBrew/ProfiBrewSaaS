...
export const modules: ModuleConfig[] = [
  {
    ...
    agendas: [
      ...
      { slug: "recipes", icon: ScrollText, labelKey: "recipes", path: "recipes" },
      { slug: "beerStyles", icon: GlassWater, labelKey: "beerStyles", path: "beer-styles" },
      { slug: "batches", icon: Flame, labelKey: "batches", path: "batches" },
      { slug: "brewingSystems", icon: Cog, labelKey: "brewingSystems", path: "brewing-systems" },
      { slug: "mashingProfiles", icon: Thermometer, labelKey: "mashingProfiles", path: "mashing-profiles" },
      { slug: "equipment", icon: Cylinder, labelKey: "equipment", path: "equipment" },
